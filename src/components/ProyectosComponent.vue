<template>
  <div class="container mx-auto px-4">
    ...
    >¿Necesita llevar a cabo un proyecto de reforma?</h2>
    ...
    <div class="lg:flex">
      ...
      >
        ...
        <div class="p-4">
          <h2 class="text-2xl font-semibold text-gray-700">Baños</h2>
          <p class="text-base text-gray-600">
      ...
      >
        ...
        <div class="p-4">
          <h2 class="text-2xl font-semibold text-gray-700">Locales / Oficinas</h2>
          <p class="text-base text-gray-600">
